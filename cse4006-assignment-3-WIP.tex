% for final touches, use: \vspace{12pt}
...
\begin{figure}[H]
\centering
\includegraphics[width=9cm]{figs/delete_announcement_mockup.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=9cm]{figs/laundry_checker_mockup.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=9cm]{figs/profile_mockup.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=9cm]{figs/architecture_schema.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=9cm]{figs/backend_module.png}
